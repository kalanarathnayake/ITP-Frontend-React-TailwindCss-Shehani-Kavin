...
const Inquiry = props => (
    <tr className='text-lg bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600'>
        <td className='w-10 px-6 py-4 overflow-x-auto text-xl font-bold'>{props.inquiry.CusName}</td>
        <td className='px-6 py-4'>{props.inquiry.type}</td>
        <td className='px-6 py-4 '> <p className='h-32 overflow-y-auto'>{props.inquiry.description}</p></td>
...
export class InquiryList extends Component {
    ...
    searchInquiryList() {
        return this.state.inquiry.map((currentinquiry) => {
            if (
                this.state.searchD === currentinquiry.type
            ) {
                return (
                    <tr className='text-lg bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600'>
